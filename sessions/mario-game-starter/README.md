# Mario Game — Starter Template

Source template for the GotPhoto AI Workshop personal project.

> **Don't edit this folder.** Run `./setup.sh` from the repo root — it copies this starter to `sessions/mario-game/` (your personal copy) and runs `npm install`. Edit `sessions/mario-game/` instead.
